...
if os.path.exists(ext_path):
    ...
    # Log-transform skewed external count features
    df["ext_log_unique_sites"] = np.log1p(df["ext_n_unique_sites"])
    df["ext_log_n_patients"]   = np.log1p(df["ext_n_patients"])
